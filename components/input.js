    ...
    <div className="flex flex-col ">
      ...
      <div className=" w-[98%] flex border-2 border-solid border-[#CCCFCE66] my-2 rounded-lg md:w-[98%] ">
        <input
          ...
          text-gray-400 pr-16 font-mono js-password sm:w-[50%] md:w-[360px]"
          type={defType}
          name={props.name}
        ...
        />{" "}
        {props.type == "password" ? (
          <div className="border-solid border-2 border-[#CCCFCE66] border-y-0 border-r-0 p-2 cursor-pointer flex items-center w-[15%]">
            {props.children || ""}
          </div>
        ) : (
          ""
