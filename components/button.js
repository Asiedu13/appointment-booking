export default function Button(props) {
  return (
    <button
      className={`flex justify-center items-center border-2 border-solid border-[#CCCFCE66] bg[#fff] p-3 mb-[20px] h-[40px] w-[360px] text-[14px] rounded text-[#808785] font-medium`}
    >
      {props.children}
    </button>
  );
